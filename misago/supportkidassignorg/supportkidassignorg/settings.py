"""
Django settings for supportkidassignorg project.
...
SECRET_KEY = '4s+7_zeq7ds%&z4+#1fr-n@c0pn7==v&ei2zmh13o4%nwx)nr^'
...
ROOT_URLCONF = 'supportkidassignorg.urls'
...
WSGI_APPLICATION = 'supportkidassignorg.wsgi.application'
